...
def plot_forces(forces, timeVec):
    fig = plt.figure()
    t = timeVec[0:len(timeVec)-1]

    plt.plot(t, forces[:,0], label='rotor 1')
    plt.plot(t, forces[:,1], label='rotor 2')
    plt.plot(t, forces[:,2], label='rotor 3')
    plt.plot(t, forces[:,3], label='rotor 4')
    plt.legend()
    plt.show()
